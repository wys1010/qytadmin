...
(function (RoleIndexApp) {
    ...
    var PermissionController = (function () {
        ...
        PermissionController.prototype.filterPermissionsOwn = function (permissionIds) {
        ...
        PermissionController.prototype.selectEntities = function () {
            ...
            this.ksEntityService.get(window.webRoot + '/management/uc/privileges/permissions/' + me.selectedRole.id + '.do', null).success(function (data) {
                me.checkedIds = data;
        ...
        PermissionController.prototype.save = function () {
            ...
            me.ksEntityService.put(window.webRoot + '/management/uc/privileges/update_permissions.do', { permissions: me.checkedIds.join(","), roleId: me.selectedRole.id }).success(function () {
    ...
    var app = angular.module('RoleIndexApp').controller("PermissionController", PermissionController);
