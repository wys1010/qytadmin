...
module OrganizationIndexApp {
	...
	app.config(['$urlRouterProvider', '$stateProvider', function ($urlRouterProvider, $stateProvider) {
		...
		$stateProvider.state('index', {
			url: '/',
			templateUrl: window.webRoot + '/uc/orgs/tpl_index.html'
		});
		...
		$stateProvider.state('index.editOrg', {
			...
			onEnter: ['$stateParams', '$state', '$modal', function ($stateParams, $state, $modal) {
				...
				$modal.open({
					backdrop: true,
					templateUrl: window.webRoot + '/uc/orgs/tpl_orgs_edit.html',
					size: 'lg'
		...
		$stateProvider.state('index.addStaff', {
			...
			onEnter: ['$stateParams', '$state', '$modal', function ($stateParams, $state, $modal) {
				...
				$modal.open({
					backdrop: true,
					templateUrl: window.webRoot + '/uc/orgs/tpl_orgs_staffs_add.html',
					size: 'lg'
				}).result.then(function (result) {
						return backToItems();
					}, function (result) {
