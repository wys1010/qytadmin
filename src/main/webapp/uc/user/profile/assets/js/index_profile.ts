...
module profileIndexApp {
    ...
    class QueryController extends ks.CommonQueryController<StaffQueryCondition, StaffEntity> {
        ...
        selectEntity(){
            var url = ks.Window.WebRoot + "/uc/user/staffs/getProfile.do";
    ...
    class EditPassController extends ks.CommonEditController<StaffEntity>{
        ...
        doSave(entity: StaffEntity){
            var self = this;
            var url = ks.Window.WebRoot + '/uc/user/staffs/updatePassword.do';
            var param:any = {
    ...
    var states = [
        {
            ...
            url: '/',
            templateUrl: ks.Window.WebRoot + '/uc/user/profile/tpl_profile_index.html',
            controller: 'QueryController'
        },
        {
            name: ks.RouterName.Edit,
            url: '/:id',
            templateUrl: ks.Window.WebRoot + '/uc/user/profile/tpl_profile_editpass.html',
