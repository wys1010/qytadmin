 ...
 */
(function () {
    angular.module('ks.orgPicker', ['ks', 'ks.cache','ks.entityService'])
        .directive('ksOrgPicker', ["$compile", 'ksCache', 'ksEntityService', 'ksTip', function ($compile, ksCache, ksEntityService, ksTip) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    var promise = ksEntityService.get(window.webRoot + '/uc/orgs/allOrganizations.do',{}).success(function (data) {
