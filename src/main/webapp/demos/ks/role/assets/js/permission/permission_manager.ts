...
module RoleIndexApp {
    ...
    export  class PermissionController{
        ...
        selectEntities() {
            ...
            this.ksEntityService.get(window.webRoot + '/uc/privileges/permissions/'+me.selectedRole.id+'.do',null)
        ...
        save(){
            ...
            me.ksEntityService.put(window.webRoot + '/uc/privileges/update_permissions.do',{permissions:me.checkedIds.join(","),roleId:me.selectedRole.id})
            .success(function(){
