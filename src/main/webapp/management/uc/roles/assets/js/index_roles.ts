...
module RoleIndexApp {
    ...
    class IndexController{
        ...
        constructor(private $scope:ng.IScope,k){
            this.k = k;
            this.init();
        }
    ...
    var app = angular.module('RoleIndexApp', ['ks.all'])
        ...
        app.config(['$urlRouterProvider', '$stateProvider', function ($urlRouterProvider, $stateProvider) {
            ...
            $stateProvider.state('index', {
                url: '/',
                templateUrl: window.webRoot + '/management/uc/roles/tpl_index.html?version=' + ks.Window.Version
            });
            ...
            $stateProvider.state('index.editRole', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function ($stateParams, $state, $modal) {
                    ...
                    $modal.open({
                        backdrop: true,
                        templateUrl: window.webRoot + '/management/uc/roles/role/tpl_role_edit.html?version=' + ks.Window.Version,
                        size: 'lg'
            ...
            $stateProvider.state('index.addStaff', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function ($stateParams, $state, $modal) {
                    ...
                    $modal.open({
                        backdrop: true,
                        templateUrl: window.webRoot + '/management/uc/roles/staff/tpl_staff_add.html?version=' + ks.Window.Version,
                        size: 'lg'
                    }).result.then(function (result) {
                            return backToItems();
                        }, function (result) {
