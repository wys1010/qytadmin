...
module OrganizationIndexApp {
    ...
    class OrgEditController{
        ...
        selectEntity(id){
            var me = this;
            this.ksEntityService.get(window.webRoot + '/management.uc/privileges/roles/' + id + ".do")
        ...
        save(){
            ...
            if(!data.id || data.id < 1){
                this.ksEntityService.post(webRoot + '/management.uc/privileges/roles/add.do',data)
                    .success(function(){
                ...
                this.ksEntityService.put(webRoot + '/management.uc/privileges/roles/update.do',data)
                    .success(function(){
                        me.$state.current.data.isChanged = true;
                        me.ksTip.success("保存成功");
                        me.dismiss();
